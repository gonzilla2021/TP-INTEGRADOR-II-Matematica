...
def es_bisiesto(años_nacimiento):
    """Verifica si los años son bisiestos"""
    for año in años_nacimiento:
        if año % 4 == 0:
            if año % 100 == 0 and año % 400 == 0:
                print(f"El año {año} es un año especial (bisiesto)")
            elif año % 100 != 0:
...
def par_impar_2000(años_nacimiento):
    """Analiza si los años son pares/impares y si son posteriores al 2000"""
    count = 0
    for año in años_nacimiento:
        if año % 2 == 0:
...
def main():
    ...
    if len(DNIs) > 1:
        ...
        print(f"UNION= {union_dnis(DNIs)}")
        print(f"Intersección de dígitos comunes: {interseccion_dnis(DNIs)}")
        print(f"Dígitos únicos del primer DNI: {diferencia_dnis(DNIs)}")
        print(f"Diferencia simétrica entre todos: {diferencia_simetrica_dnis(DNIs)}")

    # Análisis de años de nacimiento
    print("\n=== ANÁLISIS DE AÑOS DE NACIMIENTO ===")
    es_bisiesto(años_nacimiento)
    print("\n=== ANÁLISIS PAR/IMPAR Y GRUPO Z ===")
    par_impar_2000(años_nacimiento)
    print("\n=== PRODUCTO CARTESIANO ===")
    prod_cartesiano(años_nacimiento)
